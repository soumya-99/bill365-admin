...
function Bill() {
    ...
    var tot=0,net=0,totcgst=0,totsgst=0
    ...
    useEffect(() => {
      ...
      if(response)
      axios.post(url+'/admin/store_profile',{comp_id:response?.data?.msg[0].comp_id}).then(res=>{console.log(res); setInfo(res.data.msg)})
   ...
   <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body" id="divToPrint">
                  <table width="100%">
                    <tr>
                       {info?.length && <th colspan="8">{info[0]?.company_name}</th>}
                    </tr>
                    <tr>
                        <th colspan="8">Welcome Back</th>
                    </tr>
                    <tr>
                        <th colspan="8">Your Receipt</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                       ...
                       {dataSet?.length>0 && <td colspan="4">{dataSet[0]?.cust_name}</td>}
                    </tr>
                    <tr>
                    {info?.length &&  <td colspan="4">
                            Contact Number: {info[0]?.phone_no}
                            <br/>
                            Customer Care Email:{info[0].email_id}
                        </td>}
                      {dataSet?.length>0 && <td colspan="4">
                            Phone: {dataSet[0]?.phone_no}
                        </td>}
                    </tr>
                    <tr>
                        <td colspan="8">
                  ...
                  {dataSet?.map((item)=> <tr class="texAlignCenter">
                    ...
                    <tr>
                        <td >Total</td>
                        <td colspan="2">Item: {dataSet?.length}</td>
                        <td colspan="2">QTY: {totqty}</td>
                        <td colspan="2">AMT: {totAmt}</td>
                    </tr>
                    <tr>
                        <td colspan="8">
                         ========================================================
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td class="texAlignLeft" colspan="1">@{totcgst}%</td>
                        <td class="texAlignLeft" colspan="1">:</td>
                        <td class="texAlignLeft" colspan="5">{dataSet[0]?.tcgst_amt}</td>
                    </tr>
                     <tr>
                        <td colspan="1">SGST</td>
                        <td class="texAlignLeft" colspan="1">@{totsgst}%</td>
                        <td class="texAlignLeft" colspan="1">:</td>
                        <td class="texAlignLeft" colspan="5">{dataSet[0]?.tsgst_amt}</td>
                    </tr>
                    <tr>
                        <th colspan="1">Total GST</th>
                        <td></td>
                        <td class="texAlignLeft" colspan="1">:</td>
                      {dataSet?.length &&  <td class="texAlignLeft" colspan="5">{dataSet[0].tsgst_amt+dataSet[0]?.tcgst_amt}</td>}
                    </tr>
                    {dataSet[0]?.discount_flag=='Y' &&   <tr>
                        <td colspan="8">
                         ========================================================
                        </td>
                    </tr>}
            ...
            {dataSet[0]?.discount_flag=='Y' &&  <tr>
                   ...
                   {dataSet[0]?.discount_flag=='Y' && dataSet?.map((item)=> <tr>
                        <td colspan="1">Discount</td>
                        <td class="texAlignLeft" colspan="1">:</td>
                        <td class="texAlignLeft" colspan="6">{item?.discount_amt}</td>
                    </tr>)}
                    <tr>
                        <td colspan="1">Total Discount</td>
                        <td class="texAlignLeft" colspan="1">:</td>
                     {dataSet?.length>0 &&  <td class="texAlignLeft" colspan="6">{dataSet[0]?.tdiscount_amt}</td>}
                    </tr>
                    <tr>
                        <td colspan="8">
                         ========================================================
                    ...
                    <tr>
                        ...
                        {dataSet?.length>0 &&  <td class="texAlignLeft" colspan="3">{dataSet[0].round_off}</td>}
                        <td colspan="1">Net Amount:</td>
                        <td class="texAlignLeft" colspan="3">{totAmt}</td>
                    </tr>
                    <tr>
                        <td colspan="1">Receipt No:</td>
                        <td class="texAlignLeft" colspan="3">{params.id}</td>
                        <td colspan="1">Date:</td>
                        {dataSet?.length>0 &&   <td class="texAlignLeft" colspan="3">{dataSet[0].trn_date}</td>}
                    </tr>
                    <tr>
                        <td colspan="1">Cash Received:</td>
                        {dataSet?.length>0 &&   <td class="texAlignLeft" colspan="3">{dataSet[0].received_amt}</td>}
                        <td colspan="1">Returned Amount:</td>
                       {dataSet?.length>0 && <td class="texAlignLeft" colspan="3">{dataSet[0].received_amt-totAmt}</td>}
                    </tr>
                    <tr>
                        <td colspan="8">
                         ========================================================
                    ...
                    <tr class="texAlignCenter">
                        <td colspan="8">Thank You!</td>
                    </tr>
                    <tr class="texAlignCenter">
                        <td colspan="8">Visit Again...</td>
                    </tr>
                  </table>
                </div>
              </div>
