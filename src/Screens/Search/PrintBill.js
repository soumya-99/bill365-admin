       ...
       <table className="text-center">
         ...
         <tr class="flex justify-between">
          ...
          <tr class="flex justify-between">
           ...
           <td className="  text-black">
             {dataSet?.length>0 && moment(dataSet[0]?.tcreated_dt).format('DD/MM/YYYY')}
         ...
         <tr class="flex justify-between">
           ...
           <td className="col-span-1   text-black">
             {params.user}
           </td>
         </tr>
        ...
        {dataSet?.length>0 && dataSet?.map((item) => (
           <tr className="flex justify-between items-center w-full">
             ...
             <td className="w-24">{(item.price-item.discount_amt)*item.qty}</td>
           </tr>
         ))}
         ============================================================
         ...
         <tr class="flex justify-between">
           ...
           <td className="  text-black">
             {dataSet?.length>0 && Math.abs(dataSet[0]?.received_amt - dataSet[0]?.net_amt)}
