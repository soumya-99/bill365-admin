...
function DiscountSettings() {
    ...
    const handleSubmit= ()=>{
      ...
      callApi('/admin/edit_discount_settings',1,{discount_flag: discount==true?'Y':"N", discount_type: type,discount_position:position==true?'I':'B',comp_id:+comp,modified_by:localStorage.getItem('email_id')});
    }
    useEffect(()=>{
