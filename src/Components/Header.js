  ...
  return (
    ...
    <div className="flex flex-wrap justify-end items-center mx-5 min-w-screen-xl py-4 px-4">
       ...
       <div className=" text-white  space-x-4 rtl:space-x-reverse">
        <span
        className='relative right-0 text-sm sm:text-base  text-pretty text-blue-900 font-semibold'> {localStorage.getItem('company_name')}</span>
    ...
    className="font-medium text-blue-900  dark:text-gray-300 cursor-pointer">
       <Tooltip title={'Hello, '+localStorage.getItem('company_name')}>
        {/* hhh */}
       {localStorage.getItem('company_name').split(' ')[0][0]+localStorage.getItem('company_name').split(' ')[1][0]}
...
{/* <Menu
      ...
      >
        <MenuItem className='text-blue-900 hover:text-blue-900' onClick={()=>handleCloseProfile('',1)}>
          <Avatar /> 
          
          
          Store Profile
        </MenuItem>
        <MenuItem className='text-blue-900 hover:text-blue-900' onClick={()=>handleCloseProfile('',2)}>
          <Avatar /> User Profile
        </MenuItem>
        <Divider />
        {/* <MenuItem >
        ...
        <MenuItem  className='text-blue-900 hover:text-blue-900' onClick={()=>handleCloseProfile('/',3)}>
          <ListItemIcon>
