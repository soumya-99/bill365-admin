...
function GeneralSettings() {
  ...
  const handleSubmit= ()=>{
    ...
    callApi('/admin/edit_general_settings',1,{rcpt_type:type,unit_flag:unit==true?'Y':'N',cust_inf:cust_info==true?'Y':'N',
  ...
  return (
    <>
      ...
      <div className="grid gap-4 sm:grid-cols-3 sm:gap-6">
        ...
        <div className="w-full">
          ...
          <select
            id="type"
            name="type"
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value={price_type} onChange={type=>setPrice(type.target.value)}
          >
            <option selected="">Select type</option>
      ...
      <div className="flex justify-center">
          <button
            type="submit"
            className="inline-flex bg-blue-900 items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-primary-700 rounded-full focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800" onClick={()=>handleSubmit()}
          >
            Submit
          </button>
        </div>
