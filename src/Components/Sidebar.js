  ...
  return (
    <div className="bg-blue-300">
      ...
      <aside
        ...
        className=" overflow-y-auto fixed top-0 bg-blue-300 left-0 z-40 w-72 max-h-screen  transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full overflow-y-auto bg-white sticky top-0 dark:bg-gray-800 min-h-screen overflow-auto">
          <div className="bg-white w-52 flex justify-center mt-5">
            <Link
