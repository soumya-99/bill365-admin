...
const DashboardCard = ({
  ...
  return (
    <div className="transition-all hover:-translate-y-4 hover:scale-105 duration-300 cursor-pointer">
      <div
        className={`card mb-0 ${svg} bg-no-repeat bg-cover bg-white p-6 rounded-xl shadow-2xl hover:border-t-8 active:border-t-4 hover:${borderColor} transition-all duration-300 active:scale-90`}>
